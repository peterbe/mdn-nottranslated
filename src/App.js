    ...
    <div>
      ...
      <p>
        <b>
          ...
          and it's wide open of suggestions, but reports, and contributions.
        </b>
      </p>
      <p>
        ...
        first thing it does is to <i>clone</i>
        the English (US) document and then you can start overwriting the English
        with whatever language you're intending to translate to. Over the years,
        what we've come to discover is that a lot of these attempts are
        incomplete.{" "}
        <b>
          The document is actually <i>not</i> translated
        </b>
        . So, let's figure out which those implement documents are so we can
        delete them and make way for newer and better translations.
      </p>
      ...
      <p>
        ...
        documents are actually not translated. To do something about it you need
        access permission on <code>wiki.developer.mozilla.org</code> to do
        something about the document. Perhaps this can change in the future.
      </p>
    </div>
  );
}
